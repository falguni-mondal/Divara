...
const Navmenu = ({ showNav, navMenuController }) => {
  ...
  return (
    <div className={`fixed inset-0 bg-[#f9f9f9] p-[10vw] ${showNav ? "translate-x-0" : "translate-x-full"} transition-all duration-700 ease-in-out z-[998] flex flex-col justify-between pb-[30vw]`} id='mobile-nav-menu'>
